export namespace DebuggingTools {
  ...
  export namespace JSONAnalizer {
    ...
    function AnalizeJSON(data: DefinedTable, turn_arrays_into_maps: boolean = false, exact_values: boolean = false): RecursiveTable {
  ...
  export namespace Instances {
    ...
    export function GetInstanceStringTree(instance: Instance, use_full_name: boolean = false, use_class_name: boolean = false) {
    ...
    export function AnalizeInstanceStringTreeAndReturn(turn_arrays_into_maps: boolean, exact_values: boolean, ...args: Parameters<typeof GetInstanceStringTree>) {
