...
export namespace PhysicsTools {
  ...
  export function CalculateTrajectoryVerticalVelocity(horizontal_speed: number, offset: Vector3) {
    ...
    const vertical_speed = (vertical_distance * horizontal_speed + Workspace.Gravity / 2 * horizontal_distance * horizontal_distance / horizontal_speed) / horizontal_distance;
